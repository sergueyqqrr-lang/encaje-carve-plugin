...
private:
    ...
    juce::Slider   carveSlider, maxCutSlider, prioritySlider, targetSepSlider;
    juce::Label    carveLabel,  maxCutLabel,  priorityLabel,  targetSepLabel;
    juce::ComboBox roleBox, groupBox;
    juce::Label    roleLabel, groupLabel;
    juce::ToggleButton enableButton, auditionButton;

    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment>   carveAtt, maxCutAtt, priorityAtt, targetSepAtt;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> roleAtt, groupAtt;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment>   enableAtt, auditionAtt;
