...
public:
    ...
    std::atomic<float> uiOverallGainDb { 0.0f }; // ajuste de volumen general por prioridad
    std::atomic<int>   uiPriorityRank { 0 };
    std::atomic<int>   uiPriorityTiers { 1 };
...
private:
    ...
    float overallGainDbSmoothed = 0.0f;
    ...
    struct BandFilter
    {
        ...
        float appliedGainDb = 999.0f;   // fuerza el primer calculo
    };
